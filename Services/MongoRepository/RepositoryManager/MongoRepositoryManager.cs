...
namespace WhereTheRun.DataAccess.RepositoryManager
{
        ...
        where T : IEntity<TKey>
    {
        ...
        {
            get { return collection != null && !string.IsNullOrEmpty(collection.CollectionNamespace.CollectionName); }
        }
        ...
        public virtual void DropIndexes(IEnumerable<string> keynames)
        {
            ...
            {
                collection.Indexes.DropOneAsync(keyname);
            }
        }
        ...
        {
            collection.Indexes.DropAllAsync();
        }
