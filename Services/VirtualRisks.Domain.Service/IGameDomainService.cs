...
namespace CastleGo.Domain.Service
{
    ...
    {
        bool CreateSoldierIfNeed(GameAggregate game, CastleAggregate castle);
        CreateSoldierEvent GetCreateSoldierIfNeedCreate(GameAggregate game, CastleAggregate castle);
        ...
        CreateSoldierEvent GetCreateSoldierEvent(Guid gameId, Guid castleId, string troopType, string ownerUserId, bool immediately = false);
        ...
        double GetUpkeepCoinBySoldierType(CastleAggregate castle, string troopType);
