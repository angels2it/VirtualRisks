...
namespace VirtualRisks.WebApi.RestClient.Models
{
    ...
    public partial class AddTroopTypeModel
    {
        /// <summary>
        /// Initializes a new instance of the AddTroopTypeModel class.
        /// </summary>
        public AddTroopTypeModel()
        {
            CustomInit();
        }
        ...
        /// Initializes a new instance of the AddTroopTypeModel class.
        /// </summary>
        public AddTroopTypeModel(string resourceType = default(string), double? attackStrength = default(double?), int? minAttackStrength = default(int?), int? maxAttackStrength = default(int?), double? health = default(double?), int? minHealth = default(int?), int? maxHealth = default(int?), double? movementSpeed = default(double?), int? minMovementSpeed = default(int?), int? maxMovementSpeed = default(int?), string productionSpeed = default(string), int? minProductionSpeed = default(int?), int? maxProductionSpeed = default(int?), int? upkeepCoins = default(int?), int? minUpkeepCoins = default(int?), int? maxUpkeepCoins = default(int?), bool? isFlight = default(bool?), bool? isOverComeWalls = default(bool?), string icon = default(string), string blueArmyIcon = default(string), string redArmyIcon = default(string))
        {
